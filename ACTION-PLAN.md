...
> **Versão:** 1.6 · plugin em **v0.1.78 (6 providers · 3 modos com streaming · multimodal · geração de imagem funcional · aba Usage com custos em USD · Effort Engine configurável por nível · fullscreen mobile + chrome polish do OS · wikilink/áudio entram como anexo · erro não polui contexto · Coder/Study mock · agent busca o RAG)**  
